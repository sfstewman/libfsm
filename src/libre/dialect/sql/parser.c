...
#line 924 "src/libre/dialect/sql/parser.c"
		}
		/* END OF ACTION: ast-make-alt */
...
#line 945 "src/libre/dialect/sql/parser.c"
		}
...
#line 1055 "src/libre/dialect/sql/parser.c"
			}
...
#line 718 "src/libre/parser.act"
		...
		(ZInode) = ast_make_expr_literal(*flags, (*ZI195));
		if ((ZInode) == NULL) {
			goto ZL1;
		}
